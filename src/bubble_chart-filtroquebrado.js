 ...
 */
 ...
 console.log('passa aqui na 1470: ' + formatoId);
...
// Inicia a visualização
  ...
  function Carrega(formatoId,regiaoId,temporalId,publicoId,vendaId,gratisId,acessivelId,onlineId,uoId,categoriaId,datavis) {
  // Load the data.
  d3.csv('data/tudo2809.csv', display);
...
Carrega(formatoId,regiaoId,temporalId,publicoId,vendaId,gratisId,acessivelId,onlineId,uoId,categoriaId,datavis);
